...
import org.unipisa.pr2cheli.Exceptions.DataNotFoundException;
import org.unipisa.pr2cheli.Exceptions.DuplicateDataException;
import org.unipisa.pr2cheli.Exceptions.InvalidDataException;
import org.unipisa.pr2cheli.Exceptions.UnauthorizedLoginException;
...
public class App {
    ...
    public static void test1() {
        try {
            ...
            try {
                ...
                board_ale.removeCategory("nonesisto",  PW_ALE);
    ...
    public static void test2() {
        try {
            ...
            // variabili locali
            Board2<DataElement> temp_board;
            Board2<DataElement> board_ale =     new Board2<DataElement>("ale",       PW_ALE);
            Board2<DataElement> board_giorgio = new Board2<DataElement>("giorgio",   PW_GIORGIO);
            Board2<DataElement> board_chiara =  new Board2<DataElement>("chiara",    PW_CHIARA);
            Board2<DataElement> board_sara =    new Board2<DataElement>("sara",      PW_SARA);
            DataElement temp_element;
            DataElement element_tolike;
            DataElement element_tolike2;
            ...
            try {
                System.out.println("\n===> Inserisco un username invalido. Mi aspetto InvalidDataException");
                temp_board = new Board2<DataElement>(USER_INVALID, "INVALID");
            } catch(InvalidDataException e) {
                System.err.println("PASS");
                System.out.println(e);
            } catch (Exception e) {
            ...
            try {
                System.out.println("\n===> Inserisco un username vuoto. Mi aspetto InvalidDataException");
                temp_board = new Board2<DataElement>("", "INVALID");
            } catch(InvalidDataException e) {
                System.err.println("PASS");
                System.out.println(e);
            } catch (Exception e) {
            ...
            try {
                System.out.println("\n===> Inserisco un username troppo lungo. Mi aspetto InvalidDataException");
                temp_board = new Board2<DataElement>(PW_INVALID, "INVALID");
            } catch(InvalidDataException e) {
                System.err.println("PASS");
                System.out.println(e);
            } catch (Exception e) {
            ...
            try {
                System.out.println("\n===> Inserisco una password invalida. Mi aspetto InvalidDataException");
                temp_board = new Board2<DataElement>("INVALID", PW_INVALID);
            } catch(InvalidDataException e) {
                System.err.println("PASS");
                System.out.println(e);
            } catch (Exception e) {
